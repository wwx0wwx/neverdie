...
import type { AgentConfigRecord } from '@neverdie/protocol';
...
export async function agentRoutes(app: FastifyInstance) {
  ...
  app.post<{ Body: { baseUrl: string; displayName?: string } }>(
    '/api/agents',
    async (req, rep) => {
  ...
  app.delete<{ Params: { b64: string } }>('/api/agents/:b64', async (req) => {
